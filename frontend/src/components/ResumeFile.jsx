...
const ResumeFile = () => {
  ...
  const userName = user?.name || "User"; // Use "User" as fallback if name is missing
  ...
  const downloadPDF = () => {
    ...
    const printContent = `
      <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; padding: 20px;">
        <h1 style="color: #000000; margin-bottom: 10px;">${formData.name}</h1>
        <h2 style="color: #000000; margin-bottom: 20px;">${
          formData.jobTitle
        }</h2>
        
        <div style="margin-bottom: 20px;">
          <h3 style="color: #000000; border-bottom: 2px solid #3b82f6; padding-bottom: 5px;">Education</h3>
          <p><strong>${formData.degree}</strong><br>
          ${formData.institution} | ${formData.year}</p>
        </div>
        
        <div style="margin-bottom: 20px;">
          <h3 style="color: #000000; border-bottom: 2px solid #3b82f6; padding-bottom: 5px;">Skills</h3>
          <p>${formData.skillname}</p>
        </div>
        
        <div style="margin-bottom: 20px;">
          <h3 style="color: #000000; border-bottom: 2px solid #3b82f6; padding-bottom: 5px;">Experience</h3>
          <p>${formData.experience}</p>
        </div>
        
        <div style="margin-bottom: 20px;">
          <h3 style="color: #000000; border-bottom: 2px solid #3b82f6; padding-bottom: 5px;">Projects</h3>
          <ul>
            ${formData.projects
        ...
        <div style="margin-top: 30px;">
          <h3 style="color: #000000; border-bottom: 2px solid #3b82f6; padding-bottom: 5px;">Summary</h3>
            ...
            <div className="pt-4 border-t border-gray-200">
              ...
              {(!formData.name ||
                ...
                <p className="text-red-500 text-sm mt-2">
                  Please fill in all required fields: Name, Job Title, Skills,
                  and Experience
                </p>
              )}
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            {!showPreview ? (
              <div className="flex flex-col items-center justify-center h-96 text-gray-500">
                ...
                <p className="text-sm">
                  Fill in your information and click "Generate AI Resume"
                </p>
              </div>
            ) : (
